...
class Embedder(nn.Module):
    '''
    translates amino id (int) to vector (tensor)
    '''
    ...
    def __init__(self, text_embedding_vectors):
        ...
        self.embeddings = nn.Embedding.from_pretrained(
            embeddings=text_embedding_vectors, freeze=True) #from_pretrained: Creates Embedding instance from given 2-dimensional FloatTensor.
...
class Attention(nn.Module):
    '''
    translate features by Self-Attention
...
class TransformerClassification(nn.Module):
    ...
    def __init__(self, text_embedding_vectors, d_model, max_seq_len, output_dim=2):
        super().__init__()
